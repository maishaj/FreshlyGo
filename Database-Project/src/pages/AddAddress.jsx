...
import addAddressImage from "../assets/add_address_image.svg";
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between mt-10">
        ...
        <div className="flex-1 max-w-md">
          <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
            ...
            <button className='w-full mt-6 bg-primary text-white py-3 hover:bg-primary-dull transition cursor-pointer uppercate'>
              Save address
            </button>
